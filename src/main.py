...
EVENTS_FUTURE =(
    ...
    {'title':'🌴🌴🌴Boston Eaglets Club Winter Golf Escape🌴🌴🌴', 'time':'1-2-2025', 'detail':"TPC Sarasota's Private Golf and Social Club - Prestancia, tee off at 9:30 AM. Play, relax, connect. Join us for a sunny winter getaway to Florida with friends and fellow members of the Boston Eaglets Club. We are hosting 18 holes at a world-class private course, light lunch available at the clubhouse, great company, warm sunshine, and friendly competition. There are only 8 spots available! It will be first come, first served, so don't miss out! For any questions regarding this event, please contact Spencer Wu at spiolet3456@gmail.com Keep your swing strong. Build your connections. Enjoy the sunshine! 🌴Together we grow — on and off the course 🦅"},
