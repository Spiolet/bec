...
EVENTS_PAST =(
    ...
    {'title':'Fundraising at Us Kids 2025 Fall Season Championship', 'time': '2025-10-25', 'detail': "The 2025 Boston local tour Fall Season Championship at Falmouth Country Club with GREAT weather. With Halloween just around the corner, we made sure to have plenty of candy for the little golfers (and maybe for ourselves too 👀). The kids had a blast, and the energy was contagious! We’re super proud to share that we raised over $2,100 for the U.S. Kids Golf Foundation 🎉 These funds will go toward future tournaments at even cooler courses and help create awesome experiences for junior golfers next season. A big thank-you to all the volunteers and even more families than last year who helped make this event a success. Can't wait to see everyone (and even more young golfers) out on the course next season! Until then — keep swinging and have a spooktacular Halloween! 👻⛳"}
)
