      ...
      <div class="row align-items-center mb-5">
          ...
          <div id="carouselExampleIndicators" class="carousel slide shadow rounded overflow-hidden" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
              <div class="carousel-item">
                <img src="/static/pics/gg.png" class="d-block w-100" alt="pic1">
              </div>
              <div class="carousel-item active">
                <img src="/static/pics/jkg.png" class="d-block w-100" alt="pic2">
              </div>
              <div class="carousel-item">
                <img src="/static/pics/ncp.jpg" class="d-block w-100" alt="pic3">
              </div>
            </div>
        ...
        <div class="col-md-6" style="padding-left: 25px">
          ...
          <p class="lead" style="font-weight:normal">
            A welcoming community since 2023 for junior golfers across the Greater Boston area, Open to all skill levels. We play, learn, and support one another on and off the course.
          </p>
